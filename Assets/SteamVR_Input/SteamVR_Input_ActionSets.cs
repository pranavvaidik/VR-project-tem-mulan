...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_RecordAudio p_RecordAudio;
        ...
        public static SteamVR_Input_ActionSet_RecordAudio RecordAudio
        {
            get
            {
                return SteamVR_Actions.p_RecordAudio.GetCopy<SteamVR_Input_ActionSet_RecordAudio>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_RecordAudio = ((SteamVR_Input_ActionSet_RecordAudio)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_RecordAudio>("/actions/RecordAudio")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.RecordAudio};
        }
    }
}
